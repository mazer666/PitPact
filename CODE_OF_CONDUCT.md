...
repository, its issue tracker, its pull request discussions, its
chat channels, and any other space where the community gathers. It
...
## Satirical content and the line with real harm

PitPact is a satirical game that may parody bureaucracy, dogma, and
extractive power structures (see §6.2 of the Requirements
Specification). Satire in the game itself is welcome.

The same latitude does **not** extend to the community spaces around
the project. Critique of systems, ideas, and institutions is fair
game; targeting, demeaning, or harassing real people or real
protected groups is not. Moderators may use this distinction when
...
through the private channels listed in `CONTRIBUTING.md`. All
